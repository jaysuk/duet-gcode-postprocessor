...
| --- | --- | --- | --- |
| [01](01-defects.md) | Pre-hardware defect pass — the late large-file warning, backups that cannot be restored, the widget's fake version | **Ready** | — |
| [02](02-fan-audit-and-override.md) | Fan-speed audit and per-feature override | **Ready** | — |
| [03](03-machine-aware-checks.md) | `M98` macro validation, cold-extrusion and hygiene checks, Marlin tool-scoped temperatures | **Ready** | — |
